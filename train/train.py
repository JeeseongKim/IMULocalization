...
def train():
    ...
    print("Training")
    #model definition
    IMUTransformer = IMU_Transformer(window_sz=src_win_sz, hidden_dim=256, nheads=8, num_encoder_layers=6, num_decoder_layers=6, dropout=0.2).cuda()
    ...
    #load_ckpt = "/home/jsk/IMUlocalization/ckpt/train_10_square_dropout0.2/js_ans2_64.pth"
    if os.path.exists(load_ckpt):
        print("-----Loading Checkpoint-----")
        checkpoint = torch.load(load_ckpt)
        #checkpoint = torch.load("/home/jsk/IMUlocalization/ckpt/dropout0.1.pth")
    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        }, "/home/jsk/IMUlocalization/ckpt/train_10_square_dropout0.2/" + "js_ans2_" + str(epoch) + ".pth")
...
def test():
    ...
    MyCKPT = "/home/jsk/IMUlocalization/ckpt/train_10_square_dropout0.3/againFrom64js_ans2_1.pth"
